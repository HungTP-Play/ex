...
func BenchmarkEx2Recursive(b *testing.B) {
	tenCases := []struct {
		i    int
		j    int
		cost [][]int
	...
	for _, tt := range tenCases {
		for i := 0; i < b.N; i++ {
			Ex2_Recursive(tt.i, tt.j, tt.cost, &loopCount)
		}
	}
}

func BenchmarkEx2Memoization(b *testing.B) {
	tenCases := []struct {
		i    int
		j    int
		cost [][]int
	...
	for _, tt := range tenCases {
		for i := 0; i < b.N; i++ {
			...
			Ex2_Memoization(tt.i, tt.j, tt.cost, &loopCount, memo)
		}
	}
}

func BenchmarkEx2DynamicProgramming(b *testing.B) {
	tenCases := []struct {
		i    int
		j    int
		cost [][]int
	...
	for _, tt := range tenCases {
		for i := 0; i < b.N; i++ {
			...
			Ex2_DynamicProgramming(tt.i, tt.j, tt.cost, &loopCount, memo)
		}
	}
}
